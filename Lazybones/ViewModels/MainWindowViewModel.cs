...
public class MainWindowViewModel : ViewModelBase, IDisposable
{
    ...
    private async void Trigger()
    {
        ...
        try
        {
            ...
            var dialog = new Views.ModeSwitchDialog();
            ...
            var promptDismissed = dialog.UserChoice != Views.ModeSwitchDialog.Choice.StartNow
                                  && dialog.UserChoice != Views.ModeSwitchDialog.Choice.Dismiss;
            RecordCurrentCycle(CycleOutcome.CompletedNaturally, promptDismissed);

            switch (dialog.UserChoice)
            {
                case Views.ModeSwitchDialog.Choice.StartNow:
                    Toggle();
                    Resume();
                    break;
                case Views.ModeSwitchDialog.Choice.Dismiss:
                    Toggle();
                    break;
                default:
